 ...
 */
type DragTable = Array<{ Mach: number; CD: number } | DragDataPoint>;

type DragTableVariant = "G1" | "G7" | "G2" | "G5" | "G6" | "G8" | "GI" | "GS" | "TableRA4"

const DragTables: Record<DragTableVariant, DragTable> = {
    G1: [
        {
            Mach: 0.0,
            CD: 0.2629,
