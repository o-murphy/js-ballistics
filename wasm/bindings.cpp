...
BCLIBC_ShotProps shotPropsFromVal(const ShotPropsInput &props)
{
    return BCLIBC_ShotProps(
        ...
        props.diameter,
        props.weight,
        props.barrel_elevation,
        props.barrel_azimuth,
        props.sight_height,
        std::cos(props.cant_angle),
        std::sin(props.cant_angle),
        props.alt0,
        selectCalcStep(props.method) * props.config.cStepMultiplier,
        props.muzzle_velocity,
        0.0,
...
EMSCRIPTEN_BINDINGS(bclibc)
{
    ...
    value_object<BCLIBC_Atmosphere>("_Atmosphere")
        .field("_t0", &BCLIBC_Atmosphere::_t0)
        .field("_a0", &BCLIBC_Atmosphere::_a0)
        .field("_p0", &BCLIBC_Atmosphere::_p0)
        .field("_mach", &BCLIBC_Atmosphere::_mach)
    ...
    value_object<BCLIBC_Wind>("_Wind")
        .field("velocity", &BCLIBC_Wind::velocity)
        .field("direction_from", &BCLIBC_Wind::direction_from)
        .field("until_distance", &BCLIBC_Wind::until_distance)
    ...
    value_object<ShotPropsInput>("_ShotPropsInput")
        ...
        .field("look_angle", &ShotPropsInput::look_angle)
        .field("twist", &ShotPropsInput::twist)
        .field("length", &ShotPropsInput::length)
        .field("diameter", &ShotPropsInput::diameter)
        .field("weight", &ShotPropsInput::weight)
        .field("barrel_elevation", &ShotPropsInput::barrel_elevation)
        .field("barrel_azimuth", &ShotPropsInput::barrel_azimuth)
        .field("sight_height", &ShotPropsInput::sight_height)
        .field("cant_angle", &ShotPropsInput::cant_angle)
        .field("alt0", &ShotPropsInput::alt0)
        .field("muzzle_velocity", &ShotPropsInput::muzzle_velocity)
